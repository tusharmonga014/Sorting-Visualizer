    ...
    return (
      <div className='nav navbar navbar-dark bg-dark text-center p-3'>
        ...
        <div className='col-md-12 col-lg-3 row slider-controls'>
          <div className='text-white text-center text-disable-when-running slider-controls col-md-6 col-lg-6'>
            Array Size :
          </div>
          <input
            className='input-disable-when-running slider-controls col-md-6 col-lg-6'
            type="range"
            min={MIN_ARRAY_SIZE}
            max={MAX_ARRAY_SIZE}
